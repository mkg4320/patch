...
def send_start(client: pyrogram.client.Client, message: pyrogram.types.messages_and_media.message.Message):
    app.send_message(message.chat.id, f"__👋 Hey Human **{message.from_user.mention}**, i am the Link Bypasser Bot, just send me any supported links after joining my updates channel then i will get you results.\nCheckout /help to Read More__ JOIN UPdates Channel & Try 🧘👇👇",
   reply_markup=InlineKeyboardMarkup([[ InlineKeyboardButton("🎗️JOin Updates🍂", url="https://t.me/mdisk_bots")]]), reply_to_message_id=message.id)
